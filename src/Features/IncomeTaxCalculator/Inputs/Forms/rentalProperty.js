    ...
    <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
      ...
      <AccordionDetails>
        ...
        <TextField
            ...
            variant="outlined"
            value={parseFloat(props.inputs[0].turnover)-parseFloat(props.inputs[0].expenses)}
            style={{ width: 400 }}
            onChange={(event: any, newValue: string | null) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(RentalPropertyForm);
